...
// 👉 Starting by making a statement that catches viewer’s attention. The statement must always point to a problem. Something like: “Have you ever felt the communication with your team is not as effective as it should be?” or “Reporting to the project leads is an important everyday task, but ensuring that data comes from your BIM Model is even more crucial and not so easy in many cases.” Make sure your statement is as concise as possible.

// 👉 Once you got viewer’s attention, make it know that is perfectly possible to solve the problem by using the knowledge that is going to be acquired along the masterclass. Try to mention one or two key learnings of the lesson, but without too much detail to not reveal important content. Mention they will have the opportunity to learn it with a practical exercise. It’s important they know the learnings are going to be gathered by using a practical approach, while explaining important concepts along the way.

// 👉 As the viewer already know its problem can be solved really easy, you can mention the exercise to be done in the lesson. Try to explain it as brief as possible, always keeping in mind to talk about the use case of it. Needless to say, the use case must be linked with the problem being solved.

// 👉 After people know the exercise they are going to accomplish, mention the benefit of doing it. The benefit must be linked with the use case, and the use case its linked to the problem. You are basically talking about the benefit of solving the problem by studying the lesson.

// 👉 At this point, the viewer is probably eager to start right away. This is the perfect time to mention they not only have the video at its disposal, but also the guide where everything is explain step by step. This last part is a template, always use the following:

// I’m already hearing you eager to start learning, right? Well, the more resources the better! Let me tell you down below the lesson you have the guide with resources to learn more, the lesson key concepts, the step by step implementation of the exercise, the complete implementation code, and the quest you so can shine as a BIM Software Developer, everything just one click away. So, Get The Code and let’s build the open future together!

// 👉 The less, the better. It shouldn’t take too long, around 200 words is more than enough only if it fulfills the considerations above.

// TIP: Write your introduction in the same order as the considerations above, and also highlight them with the same colors so ensure everything is being addressed 😉

// Examples:

// Navigating complex BIM models can often feel overwhelming… specially when trying to understand what you are hovering over.
...
// The elements will visually respond to your mouse movements, instantly revealing what’s under the cursor.
// I know for certain that my team will be very grateful with this implementation to improve their workflow.

// BIM models are not perfect and sometimes elements intersect when they should not and we don’t even realize!
// That is why I decided to use the new Fragments 2.0 to create a Clash Detector that will help my team visualize the intersections between two models’ categories and
...
// I’ve been working a lot with it and I will teach you how to use it to create a table that shows useful information from the elements.
...
// Picture this… You are using an awesome component that is making your day to day work easier, and you think on how to make it even easier but don’t know how.
// Well.. I definitely got you. I’ve been playing around with some components from That Open Engine and now I am able to create IDS requirements with just my voice!
...
// I need to add. With this new integration, there won’t be any more limitations for new technologies that the BIM market needs.
...
// Have you ever had a fruitful conversation about your project’s issues and then didn’t know how to summarize it? Well… I had.
...
// With this useful idea, I have made my life and my team’s work a lot more easier by streamlining something as simple as a conversation.
...
// I found out how to load Autodesk’s Issues right into my BIM App to have an extended implementation with That Open Engine. I can have my revit files available and also all the issues
// related to it within one single instance of my App, everything loaded from the Construction Cloud, nice and easy. So now my team’s workflow expands even more adapting to new
// requirements and necessities.

// Lots of projects are already stored in the Autodesk Construction Cloud… and that is perfectly fine,
// but currently there is no way to load Revit files from the ACC directly to your custom BIM App.
// That’s what I thought until I put That Open Engine to the test and developed a component that does exactly that.
// The ability to load the Revit files from the cloud to my BIM App turns it into a versatile tool that takes my team’s workflow to a whole new level.
...
// We humans are very forgetful, sometimes we don’t remember what we had for breakfast. But there are things that are crucial to remember,
...
// Extracting accurate plan views from BIM models can be a real headache—especially when you need a clean DXF drawing at a specific height for coordination or documentation.
// That’s why I built a tool that lets you use a plane anywhere in your 3D model and instantly generate a DXF file of the intersection.
...
// We previously created our own DXF files… but what if instead we wanted to import them and adjust the data to our model?
